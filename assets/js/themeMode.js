...
function setLogoBasedOnMode(currentMode) {
    ...
    if (currentMode === 'dark') {
        headerLogoImg.src = 'assets/img/logo-roxo-branco.png';
        footerLogoImg.src = 'assets/img/logo-roxo-branco.png';
    } else {
        headerLogoImg.src = 'assets/img/logo-roxo.png';
        footerLogoImg.src = 'assets/img/logo-roxo.png';
    }
}
